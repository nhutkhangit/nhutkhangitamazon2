...
It is not Marketing words. Gutentor creates a single CSS file for only used Gutentor blocks in the editor, in most of the cases it is less than 50kb. Less CSS ∝ Faster Loading Sites.
