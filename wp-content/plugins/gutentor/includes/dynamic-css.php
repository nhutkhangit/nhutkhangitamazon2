	...
	class Gutentor_Dynamic_CSS {
		...
		public function fix_rtl( $post_id ) {
			...
			if ( is_array( $blocks[1] ) ) {
				/*global CSS*/
				wp_enqueue_style( 'gutentor-global-css', GUTENTOR_URL . 'assets/css/global/global' . $is_rtl . '.css' );

				/*slick CSS*/
				wp_enqueue_style( 'gutentor-slick-css', GUTENTOR_URL . 'assets/css/global/slick' . $is_rtl . '.css' );

				/*widget CSS*/
				wp_enqueue_style( 'gutentor-widget-css', GUTENTOR_URL . 'assets/css/global/widget-global' . $is_rtl . '.css' );

				/*post CSS*/
				wp_enqueue_style( 'gutentor-post-css', GUTENTOR_URL . 'assets/css/global/pg' . $is_rtl . '.css' );
